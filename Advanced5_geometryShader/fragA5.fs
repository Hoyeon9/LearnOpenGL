...
void main(){
	//ambient----
	vec3 ambient = light.ambientStrength * lightColor * texture(material.texture_diffuse1, TexCoords).rgb;
	...
	vec3 diffuse = light.diffuseStrength * lightColor * diffVal * texture(material.texture_diffuse1, TexCoords).rgb;
	...
	vec3 specular = light.specularStrength * lightColor * specVal * texture(material.texture_specular1, TexCoords).rgb;
